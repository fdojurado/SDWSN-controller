...
class SINKCOMMConfig:
    ...
    def __init__(self, name=None, host_dev=None, port_baud=None):
    ...
    def from_json(cls, json_object=None):
        ...
        return cls(name=json_object.get(NAME),
                   host_dev=json_object.get(HOST_DEV),
                   port_baud=json_object.get(PORT_BAUD))
